...
# Import Data
```{r, include = FALSE}
list.files("~/GitHub/caplter-birdcommunitydynamics/data/spp")
list.files("~/GitHub/caplter-birdcommunitydynamics/data/traits")
```
### Bird species traits
```{r, echo = TRUE}
...
data.env <- read.csv("~/GitHub/caplter-birdcommunitydynamics/data/sites/envsummaries_corebirds_combined.csv") %>%
