...
### Bird species traits
```{r, echo = TRUE}
birdtraits.all <- read.csv("./data/traits/birdtraits_corebirds2024.csv")
...
obs.all <- read.csv("./data/bird_observations_countmeanbyseason.csv", header = TRUE)
#str(obs.all)

# the abundance data for each bird count (by-survey)
  bird.counts <- readRDS("./data/bird_observations_countbysurvey.rds")
  K <- readRDS("./data/bird_observations_surveycount.rds")
...
save.image(file = "./data/modelinputs_CAPbirds2024.RData")
```
