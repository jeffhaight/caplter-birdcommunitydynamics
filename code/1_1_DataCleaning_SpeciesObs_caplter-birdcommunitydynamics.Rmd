---
title: "CAP Bird Community Dynamics - Bird Observation Data Prep"
...
write.csv(bird.list.joined, "~/GitHub/caplter-birdcommunitydynamics/data/listofspecies_corebirds.csv", row.names = FALSE)
```
...
# 
# write.csv((bird.list.joined %>% filter(code %in% unique(obs$code))), "~/GitHub/caplter-birdcommunitydynamics/data/listofspecies_corebirds_nearbyonly.csv", row.names = FALSE)
```
...
saveRDS(y.count, "~/GitHub/caplter-birdcommunitydynamics/data/bird_observations_countbysurvey.rds")
saveRDS(K, "~/GitHub/caplter-birdcommunitydynamics/data/bird_observations_surveycount.rds")
...
write.csv(obs.seas, "~/GitHub/caplter-birdcommunitydynamics/data/bird_observations_countmeanbyseason.csv", row.names = FALSE)
# write.csv(obs.all, "~/GitHub/caplter-birdcommunitydynamics/data/bird_observations_cleaned.csv", row.names = FALSE)
